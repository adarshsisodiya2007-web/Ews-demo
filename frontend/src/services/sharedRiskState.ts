...
export const DEMO_SCENARIOS: DemoScenario[] = [
  ...
  {
    id: 'scenario-b',
    label: 'Scenario B (Guwahati & Munnar Critical)',
    description: 'Flash rainfall shift: Guwahati Hills & Munnar at CRITICAL risk, Shillong HIGH, Aizawl MODERATE, Meppadi LOW',
    criticalCount: 2,
    highCount: 1,
    moderateCount: 1,
    lowCount: 1,
    areas: {
      'Guwahati Hills (NER)': {
        ...
        soilMoisture: 0.90,
        roadStatus: 'BLOCKED',
        actionProtocol: 'Immediate Evacuation & Highway Closure. Massive slope saturation on Naranarayan hills.',
        evacuationStatus: 'REROUTED',
        primaryCorridor: 'VIP Road / Narengi Hill Corridor (BLOCKED - Rockfall)',
        safeRoute: 'Recommended Evacuation Route: GS Road Arterial Expressway'
      },
      'Munnar, Idukki (Western Ghats)': {
        areaName: 'Munnar, Idukki (Western Ghats)',
        severity: 'CRITICAL',
      ...
      'Meppadi, Wayanad (Testbed)': {
        ...
        soilMoisture: 0.38,
        roadStatus: 'OPEN',
        actionProtocol: 'Normal Monitoring Active. Slope sensors nominal.',
        evacuationStatus: 'CLEAR',
  ...
  {
    id: 'scenario-c',
    label: 'Scenario C (Aizawl & Meppadi Critical)',
    description: 'Active tectonic/monsoon front: Aizawl Slopes & Meppadi at CRITICAL risk, Munnar HIGH, Guwahati MODERATE, Shillong LOW',
    criticalCount: 2,
    highCount: 1,
    moderateCount: 1,
    lowCount: 1,
    areas: {
      ...
      'Meppadi, Wayanad (Testbed)': {
        ...
        soilMoisture: 0.82,
        roadStatus: 'BLOCKED',
        actionProtocol: 'Immediate Evacuation & Highway Closure. Flash saturation in Chooralmala catchment.',
        evacuationStatus: 'REROUTED',
        primaryCorridor: 'NH-766 (BLOCKED - Sludge Inundation)',
        safeRoute: 'Recommended Evacuation Route: Vythiri Valley Relief Road'
      },
      'Munnar, Idukki (Western Ghats)': {
        areaName: 'Munnar, Idukki (Western Ghats)',
        severity: 'HIGH',
        ...
        soilMoisture: 0.74,
        roadStatus: 'AT_RISK',
        actionProtocol: 'High Landslide Risk. Pre-position disaster rescue equipment and restrict tourist buses.',
        evacuationStatus: 'CAUTION',
        primaryCorridor: 'Munnar-Mattupetty Rd (AT_RISK)',
        safeRoute: 'Recommended Evacuation Route: Old Munnar Link'
      },
      'Guwahati Hills (NER)': {
        areaName: 'Guwahati Hills (NER)',
        severity: 'MODERATE',
        ...
        soilMoisture: 0.56,
        roadStatus: 'OPEN',
        actionProtocol: 'Issue Pre-warning. Municipal earthmoving machinery on standby.',
        evacuationStatus: 'CLEAR',
      ...
      'Shillong Ridge (NER)': {
        ...
        evacuationStatus: 'CLEAR',
        primaryCorridor: 'NH-6 (OPEN)',
        safeRoute: 'Standard Transit Route: NH-6'
      }
    }
  }
];
